...
/**
 * ForNode class file.
 * This is an enhanced version of the standard Script @for loop that adds
...
extends Node
{
	...
	private $inclusive;
	/** @var string expression that provides the amount by which the loop variable changes on each iteration */
	private $step;
	...
	public function __construct($token)
	{
		...
		$this->step= empty($matches[self::STEP])
			? 1
			: $matches[self::STEP];
	}
